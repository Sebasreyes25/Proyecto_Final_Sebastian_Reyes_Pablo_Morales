...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// bt2
			// 
			this->bt2->Location = System::Drawing::Point(449, 214);
			...
			this->lbl21->Location = System::Drawing::Point(446, 148);
			this->lbl21->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl21->Name = L"lbl21";
			this->lbl21->Size = System::Drawing::Size(130, 13);
			...
			this->lbl20->Location = System::Drawing::Point(386, 174);
			this->lbl20->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl20->Name = L"lbl20";
			this->lbl20->Size = System::Drawing::Size(110, 13);
			...
			this->lbl19->Location = System::Drawing::Point(589, 43);
			this->lbl19->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl19->Name = L"lbl19";
			this->lbl19->Size = System::Drawing::Size(16, 13);
			...
			this->lbl18->Location = System::Drawing::Point(589, 8);
			this->lbl18->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl18->Name = L"lbl18";
			this->lbl18->Size = System::Drawing::Size(16, 13);
			...
			this->lbl17->Location = System::Drawing::Point(315, 216);
			this->lbl17->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl17->Name = L"lbl17";
			this->lbl17->Size = System::Drawing::Size(16, 13);
			...
			this->lbl16->Location = System::Drawing::Point(315, 185);
			this->lbl16->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl16->Name = L"lbl16";
			this->lbl16->Size = System::Drawing::Size(16, 13);
			...
			this->lbl15->Location = System::Drawing::Point(315, 152);
			this->lbl15->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl15->Name = L"lbl15";
			this->lbl15->Size = System::Drawing::Size(16, 13);
			...
			this->lbl14->Location = System::Drawing::Point(315, 119);
			this->lbl14->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl14->Name = L"lbl14";
			this->lbl14->Size = System::Drawing::Size(16, 13);
			...
			this->lbl13->Location = System::Drawing::Point(306, 43);
			this->lbl13->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl13->Name = L"lbl13";
			this->lbl13->Size = System::Drawing::Size(16, 13);
			...
			this->lbl12->Location = System::Drawing::Point(306, 10);
			this->lbl12->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl12->Name = L"lbl12";
			this->lbl12->Size = System::Drawing::Size(16, 13);
			this->lbl12->TabIndex = 51;
			this->lbl12->Text = L"...";
			// 
			// bt1
			// 
			this->bt1->Location = System::Drawing::Point(449, 81);
			this->bt1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->bt1->Name = L"bt1";
			this->bt1->Size = System::Drawing::Size(85, 48);
			...
			this->lbl7->Location = System::Drawing::Point(99, 181);
			this->lbl7->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl7->Name = L"lbl7";
			this->lbl7->Size = System::Drawing::Size(84, 13);
			...
			this->lbl6->Location = System::Drawing::Point(99, 148);
			this->lbl6->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl6->Name = L"lbl6";
			this->lbl6->Size = System::Drawing::Size(93, 13);
			...
			this->lbl5->Location = System::Drawing::Point(99, 116);
			this->lbl5->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl5->Name = L"lbl5";
			this->lbl5->Size = System::Drawing::Size(100, 13);
			...
			this->lbl4->Location = System::Drawing::Point(170, 87);
			this->lbl4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl4->Name = L"lbl4";
			this->lbl4->Size = System::Drawing::Size(98, 13);
			this->lbl4->TabIndex = 37;
			this->lbl4->Text = L"Informacion carrera";
			// 
			// tbx2
			// 
			this->tbx2->Location = System::Drawing::Point(221, 39);
			this->tbx2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->tbx2->Name = L"tbx2";
			this->tbx2->Size = System::Drawing::Size(68, 20);
			this->tbx2->TabIndex = 36;
			// 
			// tbx1
			// 
			this->tbx1->Location = System::Drawing::Point(221, 8);
			this->tbx1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->tbx1->Name = L"tbx1";
			this->tbx1->Size = System::Drawing::Size(68, 20);
			this->tbx1->TabIndex = 35;
			// 
			// lbl3
			// 
			this->lbl3->AutoSize = true;
			this->lbl3->Location = System::Drawing::Point(147, 39);
			this->lbl3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl3->Name = L"lbl3";
			this->lbl3->Size = System::Drawing::Size(53, 13);
			...
			this->lbl2->Location = System::Drawing::Point(147, 8);
			this->lbl2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->lbl2->Name = L"lbl2";
			this->lbl2->Size = System::Drawing::Size(44, 13);
			...
			this->ClientSize = System::Drawing::Size(713, 272);
			...
			this->Name = L"MyForm1";
			this->Text = L"Cálculo de Presupuesto UNIS";
